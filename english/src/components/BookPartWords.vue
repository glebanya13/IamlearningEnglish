<template>
  <div>
    <v-container fluid>
      ...
      <v-data-iterator :items="words" hide-default-footer content-tag="v-layout" row wrap>
          ...
          <v-card>
              ...
              <div class="headline">
                <v-tooltip bottom>
                  <template v-slot:activator="{ on }">
                    <v-avatar v-on="on" v-if="props.item.type == 1" color="teal" size="40">
            ...
            <v-card-text>
              <div class="headline">
                <v-tooltip bottom>
                  <template v-slot:activator="{ on }">
                    <v-avatar v-on="on" v-if="props.item.type == 2" color="indigo" size="40">
